...
public class FGsonUtils {
    ...
    public static <T> T toObject(String json, Class clazz) {
        try {
            return (T) new FGsonUtils().getInstance().fromJson(json, clazz);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static <T> T toObject(String json, Type type) {
        try {
            return (T) new FGsonUtils().getInstance().fromJson(json, type);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String toJson(Map map) {
        if (map == null) {
            ...
            return new FGsonUtils().getInstance().toJson(map);
        }
    }
