...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected String toChatUsername;  // userId 用户唯一标识符
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FLogUtil.e("聊天页面   EaseChatFragment");
...
//        messageList.setAvatarShape(1);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {  // TODO 单聊
            // set title
        ...
        if (chatType != EaseConstant.CHATTYPE_CHATROOM) {  // 聊天室
            onConversationInit();
            onMessageListInit();
        }
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public void onBubbleLongClick(EMMessage message) {
                LogUtil.e(TAG,"onBubbleLongClick");
    ...
    class MyItemClickListener implements EaseChatExtendMenu.EaseChatExtendMenuItemClickListener{
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
            case ITEM_TAKE_PICTURE:  // 选择相机  拍照
...
//        EMMessage message1 = EMMessage.createSendMessage(EMMessage.Type.TXT);
//        TextMessageBody txtBody = new TextMessageBody(content);
//        message.addBody(txtBody);

        //增加自己的属性
        message.setAttribute("CARDS",true);
        message.setAttribute("USER_TITLE","God-Eye");
        message.setAttribute("USERID","1");
        message.setAttribute("USER_IMAGE","");
        message.setAttribute("USER_CONTENT","青岛");
        message.setAttribute("USER_URL","");
        //设置群聊和聊天室发送消息
        if (chatType == EaseConstant.CHATTYPE_GROUP){
