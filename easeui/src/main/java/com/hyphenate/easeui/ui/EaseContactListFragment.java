...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    protected List<EaseUser> contactListQQQ;  // TODO 给通讯录中设置数据  1
    protected ListView listView;
    protected boolean hidden;
    protected ImageButton clearSearch;
    protected EditText query_tong_xun_lu;   // 搜索
    protected Handler handler = new Handler();
    protected EaseUser toBeProcessUser;
    protected String toBeProcessUsername;
    protected EaseContactList contactListLayout;   // 联系人列表
    protected boolean isConflict;
    protected FrameLayout contentContainer;  // 添加头部 申请通知、群聊、聊天室、环信小助手、音视频会议的布局
    ...
    protected void initView() {
        ...
        //search
        query_tong_xun_lu = (EditText) getView().findViewById(R.id.query);
    ...
    protected void setUpView() {
        ...
        contactListQQQ = new ArrayList<EaseUser>();
        getContactList();
        //init list
        contactListLayout.init(contactListQQQ);  // TODO 给通讯录中设置数据 2
        ...
        // 搜索监听
        query_tong_xun_lu.addTextChangedListener(new TextWatcher() {
        ...
        clearSearch.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                query_tong_xun_lu.getText().clear();
                hideSoftKeyboard();
            }
        });
    ...
    protected void getContactList() {
        ...
        // sorting
        Collections.sort(contactListQQQ, new Comparator<EaseUser>() {
