...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getType() == EMMessage.Type.TXT) {
            ...
            } else if (message.getBooleanAttribute("CARDS", false)) { // TODO 新增分享
        ...
        switch (message.getType()) {
            case TXT:
                if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
                    ...
                    LogUtil.e("解析消息传递过来的值 = ", message.getBooleanAttribute("CARDS", false));
					if (message.getBooleanAttribute("CARDS",false)){
                        presenter = new EyeChatCardPresenter(); // TODO 需要自己创建
                    } else {
