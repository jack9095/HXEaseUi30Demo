 ...
 *
 */
public class BaseEaseConversationAdapter extends ArrayAdapter<EMConversation> {
    protected static final String TAG = "ChatAllHistoryAdapter";
    protected List<EMConversation> conversationList;
    protected List<EMConversation> copyConversationList;
    protected ConversationFilter conversationFilter;
    ...
    public BaseEaseConversationAdapter(Context context, int resource,
