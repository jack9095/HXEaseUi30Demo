package easemob.com.hxlibrary.adapter;
...
//			ImageLoaderManager.getInstance().displayCircleImage(parent.getContext(),
//					R.drawable.em_create_group,
//					((ImageView) convertView.findViewById(R.id.avatar)),R.drawable.em_create_group);
...
//			ImageLoaderManager.getInstance().displayCircleImage(parent.getContext(),
//					R.drawable.em_add_public_group,
//					((ImageView) convertView.findViewById(R.id.avatar)),R.drawable.em_add_public_group);
...
//			ImageLoaderManager.getInstance().displayCircleImage(parent.getContext(),
//					R.drawable.em_group_icon,
//					((ImageView) convertView.findViewById(R.id.avatar)),R.drawable.em_group_icon);
		}
