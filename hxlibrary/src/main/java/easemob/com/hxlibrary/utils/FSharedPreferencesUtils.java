package easemob.com.hxlibrary.utils;
...
public class FSharedPreferencesUtils {
    ...
    private static FSharedPreferencesUtils sharePref = null;
     ...
     * @return
     */
    public synchronized static FSharedPreferencesUtils getInstance(String PREF_NAME, Context context) {
        if (sharePref != null) {
            return sharePref;
        } else {
            return new FSharedPreferencesUtils(PREF_NAME, context);
        }

    }

    /**私有化构造函数并创建SharedPreferences*/
    private FSharedPreferencesUtils(String PREF_NAME, Context context) {
