...
import easemob.com.hxlibrary.conference.LiveActivity;
import easemob.com.hxlibrary.conversation.VideoCallActivity;
import easemob.com.hxlibrary.conversation.VoiceCallActivity;
import easemob.com.hxlibrary.db.DemoDBManager;
import easemob.com.hxlibrary.db.InviteMessgeDao;
import easemob.com.hxlibrary.db.UserDao;
import easemob.com.hxlibrary.domain.EmojiconExampleGroupData;
import easemob.com.hxlibrary.domain.InviteMessage;
import easemob.com.hxlibrary.domain.InviteMessage.InviteMessageStatus;
import easemob.com.hxlibrary.domain.RobotUser;
import easemob.com.hxlibrary.parse.UserProfileManager;
import easemob.com.hxlibrary.receiver.CallReceiver;
import easemob.com.hxlibrary.receiver.HeadsetReceiver;
...
//        options.setImPort(31097);
    ...
    private EMOptions initChatOptions(Context context){
        ...
        /**
         * NOTE: TODO 你需要设置自己申请的账号来使用三方推送功能，详见集成文档
         */
...
//        options.setPushConfig(builder.build());
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.setUserProfileProvider(new EaseUserProfileProvider() {
            ...
            public EaseUser getUser(String username) {
                ...
                FLogUtil.d("会话页面根据username 获取昵称和头像", FGsonUtils.toJson(userInfo));
                return userInfo;
            }
        });
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactAdded(String username) {
            // save contact
            FLogUtil.e("getContactListWWW   6");
            Map<String, EaseUser> localUsers = getContactListWWW();
        ...
        public void onContactDeleted(String username) {
            FLogUtil.e("getContactListWWW   5");
            Map<String, EaseUser> localUsers = DemoHelper.getInstance().getContactListWWW();
        ...
        public void onContactEvent(int event, String target, String ext) {
            switch (event) {
                case EMMultiDeviceListener.CONTACT_REMOVE: {
                    FLogUtil.e("getContactListWWW   4");
                    Map<String, EaseUser> localUsers = getContactListWWW();
                ...
                {
                    FLogUtil.e("getContactListWWW   3");
                    Map<String, EaseUser> localUsers = getContactListWWW();
...
//                break;
                case CONTACT_BAN:
                    ...
                    FLogUtil.e("getContactListWWW   2");
                    Map<String, EaseUser> localUsers = DemoHelper.getInstance().getContactListWWW();
                    localUsers.remove(username);
                    userDao.deleteContact(username);
                    inviteMessgeDao.deleteMessage(username);
...
//        appContext.startActivity(intent);
        ...
        monSingleSignOnListener.onSingleOut(exception);
        FLogUtil.e("异常&***************************************&&&&&&&&&&&&&&&&&&& = ",exception);

        showToast(exception);
    }

    public void setOnSingleSignOnListener(OnSingleSignOnListener monSingleSignOnListener){
        this.monSingleSignOnListener = monSingleSignOnListener;
    }
    private OnSingleSignOnListener monSingleSignOnListener;
    public interface OnSingleSignOnListener{
        void onSingleOut(String str);
        void onLeOutSuccess();
    }
    ...
    private EaseUser getUserInfo(String username){
        ...
        user = getContactListWWW().get(username);
        FLogUtil.d("会话页面根据username 获取昵称和头像111 = ", FGsonUtils.toJson(user));
    ...
    public void logout(boolean unbindDeviceToken, final EMCallBack callback) {
        ...
        EMClient.getInstance().logout(unbindDeviceToken, new EMCallBack() {
            ...
            public void onSuccess() {
                ...
                // TODO 退出登录成功
                if (monSingleSignOnListener != null) {
                    monSingleSignOnListener.onLeOutSuccess();
                }
                reset();
                if (callback != null) {
                    callback.onSuccess();
     ...
     * TODO 通讯录获取数据
     * TODO 通讯录获取数据
     * key 为环信的 userName 也就是我们通常说的 userId, value 为用户信息
     * @return
     */
    public Map<String, EaseUser> getContactListWWW() {
        FLogUtil.d("DemoHelp  isLoggedIn() = ", isLoggedIn());
//        FLogUtil.e("DemoHelp  contactList = ", FGsonUtils.toJson(contactList));
        if ((isLoggedIn() && contactList == null) || (FSharedPreferencesUtils.getSharePrefBoolean("tong_xun_lu"))) {
            FLogUtil.e("DemoHelp = ", "进来了");
            FSharedPreferencesUtils.putSharePrefBoolean("tong_xun_lu",false);
            contactList = demoModel.getContactList();
        } else {
            FLogUtil.d("DemoHelp = ", "没进去");
        }
...
//        FLogUtil.e("从数据库中获取通讯录的数据 helper ",FGsonUtils.toJson(contactList));
        return contactList;
    }
        ...
        new Thread(){
            ...
            public void run(){
                ...
                try {
                    ...
                    getContactListWWW().clear();
                    getContactListWWW().putAll(userlist);
                    FLogUtil.e("getContactListWWW   1");
