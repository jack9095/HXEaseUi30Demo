package easemob.com.hxlibrary.conference;
...
import easemob.com.hxlibrary.utils.PhoneStateManager;
import easemob.com.hxlibrary.widget.EasePageIndicator;

/**
 * Created by lzan13 on 2017/8/15.
 * TODO 多人音视频会议界面
 */
public class ConferenceActivity extends HXBaseActivity implements EMConferenceListener {
...
//            incomingCallView.setVisibility(View.VISIBLE);
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            } else if (i == R.id.btn_mic_switch) {
                voiceSwitch();

            } else if (i == R.id.btn_speaker_switch) {
            ...
            } else if (i == R.id.btn_change_camera_switch) {
                changeCamera();
            ...
            } else if (i == R.id.btn_scale_mode) {
                changeFullScreenScaleMode();

            } else if (i == R.id.btn_close) {
                showFloatWindow();

            } else if (i == R.id.btn_zoomin) {// exit full screen mode.
