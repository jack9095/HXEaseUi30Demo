...
import easemob.com.hxlibrary.group.ExitGroupDialog;
import easemob.com.hxlibrary.sendchat.ChatActivity;

/**
 * 聊天室详情
 */
public class ChatRoomDetailsActivity extends HXBaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		@SuppressLint("WrongViewCast") EaseExpandGridView userGridView = (EaseExpandGridView) findViewById(R.id.gridview);
